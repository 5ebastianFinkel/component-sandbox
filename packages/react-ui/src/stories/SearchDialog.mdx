...
- 🔍 **Fast Search**: Powered by FlexSearch with dual-index architecture
- ⌨️ **Keyboard Shortcuts**: Global CMD/CTRL+K shortcut and navigation
- 📚 **Content Types**: Searches both stories and documentation
- 🏷️ **Advanced Filtering**: Search shortcuts for precise filtering
- 📖 **Search History**: Persistent search history with localStorage
- 🎯 **Smart Ranking**: Relevance-based result scoring
- ♿ **Accessible**: Full keyboard navigation and ARIA support
- 📱 **Responsive**: Mobile-friendly design
- ⚡ **Performance**: Caching, debouncing, and virtualization
